...
const Header: React.FC<HeaderProps> = ({ onSelectionChange, version = 'v1', onBookmarksDataChange, onCategoryChange }) => {
    ...
    const containerPaddingClasses = version === 'v3' ? "pl-5 pr-2 md:pr-0 pt-3 pb-2" : "pl-2 pr-2 md:pr-0 pt-3 pb-2";
    ...
    return (
        <header className={headerClasses}>
            <div className={`${containerPaddingClasses} flex items-center h-full`}>
                ...
                <div className={`flex items-center flex-1 min-w-0 h-full ${version === 'v3' ? 'justify-start gap-x-5 md:gap-x-5' : 'gap-x-4 md:gap-x-6'}`}>
                    ...
                    {/* Quick Create Menu - V3 Only */}
                    {version === 'v3' && (
                        <div className="flex items-center justify-center shrink-0 -mx-4 pr-4" style={{ width: '82px' }}>
                            <QuickCreateMenu
                                mode="header"
