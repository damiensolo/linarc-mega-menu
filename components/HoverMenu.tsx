...
const HoverMenu: React.FC<HoverMenuProps> = ({ navigationData, menuLayout, onSelect }) => {
    return (
        <motion.div
            ...
            className="absolute top-full left-0 mt-4 bg-white rounded-xl shadow-2xl p-8 z-50 origin-top-left max-h-[calc(100vh-8rem)] overflow-y-auto"
        >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 text-black" style={{minWidth: 'min(850px, 100vw - 2rem)'}}>
                <div className="space-y-8 border-r-0 md:border-r border-gray-100 pr-8 pb-8 md:pb-0">
